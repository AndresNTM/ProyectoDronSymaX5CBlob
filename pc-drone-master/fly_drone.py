...
vc.set(cv2.cv.CV_CAP_PROP_FPS,fps) 
...
try: 
    ...
    while rval:
        ...
        flighttoc=timeit.default_timer()
        cv2.putText(frame, command,(10,50), font, .8,(255,255,255),2,cv2.CV_AA)
        ...
        cv2.putText(frame, 'Flt#: {0} Time:{1:0.3f}'.format(flightnum,flighttoc-flighttic),(10,75), font, .8,(255,255,255),2,cv2.CV_AA)
